...
G4double G4GeometryConstants::wafer_thickness = 3000 * um;
G4double G4GeometryConstants::curvature_radius = focal_length * 2;
G4double G4GeometryConstants::spoke_width = 300 * um;
G4double G4GeometryConstants::pore_size = 40 * mm;
G4double G4GeometryConstants::hole_size = 20 * mm;
G4double G4GeometryConstants::spoke_thickness = 1 * um;
G4double G4GeometryConstants::effarea_size = 30 * cm;
