...
G4double G4GeometryConstants::focal_length = 100 * mm;
...
G4double G4GeometryConstants::effarea_size = 4.5 * cm;
G4double G4GeometryConstants::randomize_fraction = 12.8;

G4double G4GeometryConstants::plate_size = 5 * cm;

/*
//for test
G4double G4GeometryConstants::focal_length = 300 * mm;
G4double G4GeometryConstants::wafer_thickness = 1 * mm;
G4double G4GeometryConstants::curvature_radius = focal_length * 2;
G4double G4GeometryConstants::spoke_width = 300 * um;
G4double G4GeometryConstants::pore_size = 9 * mm;
G4double G4GeometryConstants::hole_size = 4.5 * mm;
G4double G4GeometryConstants::spoke_thickness = 1 * um;
